...
export const GithubFolder = ({ data, handleClick, isColor }: any) => {
  return (
    <TableContainer sx={{ ...styles.tableContainer, cursor: "pointer", marginTop:'10px' }}>
          ...
          {data?.map((item: any, i: number) => {
            return (
              <TableRow
                ...
                sx={{ background: isColor == item.id ? "#F2F4F7" : "" }}
              >
                <TableCell>
                ...
                <TableCell>
                  <Box sx={styles.tableCell}>
                    {item.osSimilarity && (
                      <>
                        {item.osSimilarity?.icon && (
                          <Image
                            src={item.osSimilarity?.icon}
                            width={20}
                            height={20}
                            alt="warning"
                          />
                ...
                <TableCell>
                  <Box sx={styles.tableCell}>
                    {item.osLicience && (
                      <>
                        {item.osLicience?.icon && (
                          <Image
                            src={item.osLicience?.icon}
                            width={20}
                            height={20}
                            alt="warning"
                          />
                ...
                <TableCell>
                  <Box sx={styles.tableCell}>
                    <Image src={item.engines} width={20} height={20} alt="" />
                  </Box>
                </TableCell>
