...
import microsft from "@/common/assets/images/microsoft.svg"
...
export const Rows: any = [
  {
    ...
    policiesMainData: [
      {
        threat: "Access data exposed to the user",
        type: "Intent",
        apps: "All",
        groups: "All",
        severity: "Multiple",
      ...
      {
        threat: "Access data leaked to engine",
        type: "Intent",
        apps: "All",
        groups: "All",
        severity: "Multiple",
      ...
      {
        threat: "Unauthorized user access attempt to legal document",
        type: "Intent",
        apps: "All",
        groups: "Not in Legal",
        severity: "High",
      ...
      {
        threat: "Unauthorized user attempt to access client data",
        type: "Intent",
        apps: "All",
      ...
      {
        threat: "Unauthorized user attempt to access finance data",
        type: "Intent",
        apps: "All",
        ...
        policiesData: [
          {
            ...
            type: "Block",
            threat: "Attempt to advise the model regarding strategic decision making",
            apps: "All",
            groups: "All",
            severity: "High",
            actions: "Block",
            engine: [{text:"Claude", icon:claud}],
            assets: "R&D",
            integration: ["GDPR", "EU AI Act", "CSF - NIST"],
            severityLevel: "Critical",
          },
...
export const CHECK_BOXES = ["EU AI Act","Solvency II","HIPAA","OWASP","NIST","GDPR","MITRE ATLAS","GLBA","IDD"];
