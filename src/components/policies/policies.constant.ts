...
export const Rows: any = [
  {
    ...
    policiesMainData: [
      ...
      },
      {
        ...
        type: "Intent",
        apps: "All",
        groups: "Unauthorized user access attempt to legal document",
        severity: "High",
        actions: "Block",
        component: CustomSwitch,
        action: AssetsDropdown,
      ...
      },
      {
        ...
        type: "Intent",
        apps: "All",
        groups: "Not in Client leadership or Executives",
        severity: "High",
        actions: "Mask",
        component: CustomSwitch,
        action: AssetsDropdown,
      ...
      {
        threat: "Unauthorized user’s attempt to share client data",
        type: "Intent",
        apps: "All",
        groups: "Unauthorized user’s attempt to share client data",
        severity: "Critical",
        actions: "Block",
        component: CustomSwitch,
        action: AssetsDropdown,
      ...
      {
        threat: "Unauthorized user attempt to access Intellectual property data",
        type: "Intent",
        apps: "All",
        groups: "Not in Executives or R&D Innovation",
        severity: "High",
        actions: "Block",
        component: CustomSwitch,
        action: AssetsDropdown,
      ...
      {
        threat: "Unauthorized user attempt to share Intellectual property data",
        type: "Intent",
        apps: "All",
        groups: "Not in Executives or R&D Innovation",
        severity: "Critical",
